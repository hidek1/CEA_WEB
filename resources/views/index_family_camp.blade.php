...
<div class="container">
  <div class="row">
    <div class="col-xs-4 col-md-4 col-lg-4">
        <img src="{{ asset('images/Junior man to man.jpg') }}" class="img-responsive zoomable" width="100%">
    </div>
    <div class="col-xs-4 col-md-4 col-lg-4">
        <img src="{{asset('images/00018.jpg') }}" class="img-responsive zoomable" width="100%">
    </div>
    <div class="col-xs-4 col-md-4 col-lg-4">
        <img src="{{ asset('images/SATURDAYCLASS2.jpg') }}" class="img-responsive zoomable" width="100%">
    </div>
  </div>
